...
public typealias DownloadFileCompletionType = (Data?, URL?, FileModel?, ChatError?) -> Void
public typealias DownloadImageCompletionType = (Data?, URL?, ImageModel?, ChatError?) -> Void
