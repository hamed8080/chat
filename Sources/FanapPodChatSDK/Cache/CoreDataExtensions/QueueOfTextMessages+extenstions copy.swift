...
extension QueueOfTextMessages{
    ...
    public func getCodable() -> SendTextMessageRequest?{
    ...
    public class func convertToCM(request:SendTextMessageRequest  ,entity:QueueOfTextMessages? = nil) -> QueueOfTextMessages{
    ...
    public class func insert(request:SendTextMessageRequest , resultEntity:((QueueOfTextMessages)->())? = nil){
