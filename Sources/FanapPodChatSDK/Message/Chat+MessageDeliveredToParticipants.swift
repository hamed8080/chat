...
// Request
extension Chat {
    func requestMessagedeliveredToParticipnats(_ req: MessageDeliveredUsersRequest, _ completion: @escaping CompletionType<[Participant]>, _ uniqueIdResult: UniqueIdResultType? = nil) {
...
extension Chat {
    func onMessageDeliveredToParticipants(_ asyncMessage: AsyncMessage) {
        ...
        callbacksManager.removeCallback(uniqueId: chatMessage.uniqueId, requestType: .messageDeliveredToParticipants)
    }
}
