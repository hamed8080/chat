//
// CallInquiryResponseHandler.swift
...
class CallInquiryResponseHandler {
    static func handle(_ asyncMessage: AsyncMessage) {
        ...
        chat.callbacksManager.removeCallback(uniqueId: chatMessage.uniqueId, requestType: .callInquiry)
    }
}
