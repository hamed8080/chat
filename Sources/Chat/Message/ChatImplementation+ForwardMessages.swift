//
// ChatImplementation+ForwardMessages.swift
...
public extension ChatImplementation {
    ...
    func forwardMessages(_ request: ForwardMessageRequest, onSent: OnSentType? = nil, onSeen: OnSeenType? = nil, onDeliver: OnDeliveryType? = nil, uniqueIdsResult: UniqueIdsResultType? = nil) {
        ...
        prepareToSendAsync(req: request, type: .forwardMessage, completion: nil as CompletionType<Voidcodable>?, onSent: onSent, onDelivered: onDeliver, onSeen: onSeen)
