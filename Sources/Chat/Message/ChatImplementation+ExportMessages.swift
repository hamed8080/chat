//
// ChatImplementation+ExportMessages.swift
...
public extension ChatImplementation {
    ...
    func exportChat(_ request: GetHistoryRequest, completion: @escaping CompletionTypeNoneDecodeable<URL>, uniqueIdResult _: UniqueIdResultType? = nil) {
...
private class ExportMessages: ExportMessagesProtocol {
    ...
    init(chat: ChatImplementation, request: GetHistoryRequest, completion: @escaping CompletionTypeNoneDecodeable<URL>, uniqueIdResult: UniqueIdResultType? = nil) {
