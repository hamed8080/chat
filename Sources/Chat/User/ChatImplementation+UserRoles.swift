//
// ChatImplementation+UserRoles.swift
...
public extension ChatImplementation {
    ...
    func setRoles(_ request: RolesRequest, completion: @escaping CompletionType<[UserRole]>, uniqueIdResult: UniqueIdResultType? = nil) {
    ...
    ///   - uniqueIdResult: The unique id of request. If you manage the unique id by yourself you should leave this closure blank, otherwise, you must use it if you need to know what response is for what request.
    func setAuditor(_ request: AuditorRequest, completion: @escaping CompletionType<[UserRole]>, uniqueIdResult: UniqueIdResultType? = nil) {
        prepareToSendAsync(req: request, type: .setRuleToUser, uniqueIdResult: uniqueIdResult, completion: completion)
    }
