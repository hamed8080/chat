//
// ChatImplementation+MutualGroups.swift
...
public extension ChatImplementation {
    ...
    func mutualGroups(_ request: MutualGroupsRequest, completion: @escaping CompletionType<[Conversation]>, cacheResponse: CacheResponseType<[Conversation]>? = nil, uniqueIdResult: UniqueIdResultType? = nil) {
