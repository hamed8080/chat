//
// ChatImplementation+DeleteThread.swift
...
public extension ChatImplementation {
    ...
    func deleteThread(_ request: GeneralSubjectIdRequest, completion: @escaping CompletionType<Int>, uniqueIdResult: UniqueIdResultType? = nil) {
        prepareToSendAsync(req: request, type: .deleteThread, uniqueIdResult: uniqueIdResult, completion: completion)
    }
}
