//
// ChatImplementation+AssistantsHistory.swift
...
public extension ChatImplementation {
    ...
    func getAssistatsHistory(completion: @escaping CompletionType<[AssistantAction]>, uniqueIdResult: UniqueIdResultType? = nil) {
        let req = BareChatSendableRequest()
        prepareToSendAsync(req: req, type: .getAssistantHistory, uniqueIdResult: uniqueIdResult, completion: completion)
    }
}
