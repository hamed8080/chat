//
// ChatImplementation+DownloadMapStaticImage.swift
...
public extension ChatImplementation {
    ...
    func mapStaticImage(_ request: MapStaticImageRequest, downloadProgress: DownloadProgressType? = nil, completion: @escaping CompletionType<Data?>, uniqueIdResult: UniqueIdResultType? = nil) {
