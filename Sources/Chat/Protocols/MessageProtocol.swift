...
public protocol MessageProtocol {
    ...
    func allUnreadMessageCount(_ request: AllThreadsUnreadCountRequest, completion: @escaping CompletionType<Int>, cacheResponse: CacheResponseType<Int>?, uniqueIdResult: UniqueIdResultType?)
...
public extension MessageProtocol {
    ...
    ///   - completion: The number of unread message count.
    ///   - cacheResponse: The number of unread message count in cache?.
    func allUnreadMessageCount(_ request: AllThreadsUnreadCountRequest, completion: @escaping CompletionType<Int>, cacheResponse: CacheResponseType<Int>?) {
