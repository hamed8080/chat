...
## What is Spec?
Spec comes from specification and it comprises of base addresses and their paths for the socket server and other servers. You can find one in [Spec](). You have to parse it and pass it to the config. 
