...
Thank you for considering contributing to ChatCore.

Please know that everyone is welcome to contribute to ChatCore.
...
ChatCore is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to ChatCore,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/chatcore/issues/new/choose) 
...
All changes to ChatCore source must go through the PR review process before
...
ChatCore is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/chatcore.git
    ```
...
4. Build ChatCore from the command line by running:
