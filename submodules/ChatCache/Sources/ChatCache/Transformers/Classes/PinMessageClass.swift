...
public class PinMessageClass: NSObject, Codable, Identifiable {
    public static func == (lhs: PinMessageClass, rhs: PinMessageClass) -> Bool {
...
public extension PinMessage {
    var toClass: PinMessageClass {
        let pinMessage = PinMessageClass(messageId: messageId,
                                         text: text,
                                         time: time,
                                         timeNanos: timeNanos,
                                         sender: sender,
...
public extension PinMessageClass {
    var toStruct: PinMessage {
        let pinMessage = PinMessage(messageId: messageId,
                                    text: text,
                                    time: time,
                                    timeNanos: timeNanos,
                                    sender: sender,
