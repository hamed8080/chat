...
Thank you for considering contributing to ChatDTO.

Please know that everyone is welcome to contribute to ChatDTO.
...
ChatDTO is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to ChatDTO,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/chat-dto/issues/new/choose) 
...
All changes to ChatDTO source must go through the PR review process before
...
ChatDTO is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/chat-dto.git
    ```
...
4. Build ChatDTO from the command line by running:
