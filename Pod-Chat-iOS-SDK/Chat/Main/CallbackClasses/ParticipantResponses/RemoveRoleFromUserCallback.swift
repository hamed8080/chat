...
extension Chat {
    ...
    /// RemoveRoleFromUser Response comes from server
    ///
    /// - Outputs:
    ///    - it doesn't have direct output,
    ///    - but on the situation where the response is valid,
    ///    - it will call the "onResultCallback" callback to removeRole/removeAdmin function (by using "removeRoleFromUserCallbackToUser")
