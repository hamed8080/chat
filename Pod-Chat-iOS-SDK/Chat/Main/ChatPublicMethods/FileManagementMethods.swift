...
extension Chat {
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.isImageAvailable(hashCode)")
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.isFileAvailable(hashCode)")
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.isThumbnailAvailable(hashCode)")
...
//                                              id:           getImageInput.imageId,
    ...
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.totoalUsedSpace()")
    ...
    /// - it has only one return value as Int that represents data as Byte
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.retrieveAllImagesSize()")
    ...
    /// - it has only one return value as Int that represents data as Byte
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.retrieveAllFilesSize()")
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.deleteAllImages()")
    ...
    /// Outputs:
    /// - this method has no output
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.deleteAllFiles()")
    ...
    /// Outputs:
    /// - this method has no output
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFileManager.sharedInstance.deleteAllFilesWithCache()")
    ...
    /// Outputs:
    /// - this method has no output
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.write(cacheType: .DELETE_ALL_CACHE_DATA)")
