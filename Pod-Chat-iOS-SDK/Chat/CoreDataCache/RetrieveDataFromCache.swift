...
extension Cache {
    ...
    ///     UserInfoModel?
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .USER_INFO)")
    ...
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .CUREENT_USER_ROLES(threadId))")
    ...
    ///     GetContactsModel?
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .GET_CASHED_CONTACTS(request))")
...
//            }
    ...
    /// - returns:
    ///     [Contact]?
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .PHONE_CONTACTS)")
...
//                                              uniqueId:         nil,
    ...
    ///     GetThreadsModel?
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .GET_THREADS(ThreadsRequest))")
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .NEW_THREADS(count, offset))")
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .PIN_THREADS)")
    ...
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .THREAD_PARTICIPANTS(threadId, count, offset: offset, ascending))")
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .THREAD_ADMINS(threadId))")
    ...
    @available(*,deprecated , message:"Removed in XX.XX.XX version. use CacheFactory.get(cacheType: .ALL_UNREAD_COUNT)")
    ...
    ///     GetHistoryModel?
    ///
    @available(*,deprecated , message:"Removed in XX.XX.XX version.use CacheFactory.get(cacheType: .GET_HISTORY(req))")
