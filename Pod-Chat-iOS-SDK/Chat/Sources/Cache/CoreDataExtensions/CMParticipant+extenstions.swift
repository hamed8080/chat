...
extension CMParticipant{
    ...
    public class func convertParticipantToCM(participant:Participant, fromMainMethod:Bool ,threadId:Int? ,entity:CMParticipant? = nil) -> CMParticipant{
    ...
    public class func insertOrUpdate(participant:Participant,fromMainMethod:Bool = false,threadId:Int? , resultEntity:((CMParticipant)->())? = nil){
    ...
    public class func insertOrUpdateParicipants(participants:[Participant]?,fromMainMethod:Bool = false,threadId:Int? , resultEntity:((CMParticipant)->())? = nil){
