...
class SyncContactsRequestHandler {
    ...
    class func splitContactsToSync(_ contacts:[AddContactRequest]) -> [[AddContactRequest]]{
        return contacts.chunked(into: SyncContactsRequestHandler.chunkCount)
    }
    
    static var contactsPsrts:[[AddContactRequest]] = []
